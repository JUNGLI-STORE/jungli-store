...
export default function SuccessPage() {
  return (
    // Navbar removed from here because layout.tsx handles it
    <main className="min-h-screen bg-white flex items-center justify-center px-6">
      ...
      >
        ...
        <p className="font-bold italic text-gray-600 mb-8 text-sm leading-relaxed">
          Your drip is being secured. We have sent a confirmation email. 
          You can track the live status directly from your <Link href="/profile" className="underline text-black decoration-2">Profile Section</Link>.
          Stay wild.
        </p>
