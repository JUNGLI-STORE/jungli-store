  ...
  return (
    <main className="min-h-screen bg-gray-100 flex items-center justify-center px-6 py-20">
      ...
      >
        ...
        <h1 className="text-5xl font-[1000] uppercase italic tracking-tighter mb-2 text-black leading-none">
          JOIN THE <span className="text-jungli-orange text-6xl">JUNGLE</span>
        </h1>
        <p className="font-bold text-gray-500 italic mb-8 uppercase text-[10px] tracking-widest leading-tight">
          India's No. 1 Stash. Join to track orders & get early access.
        </p>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          <div className="relative group">
            ...
            <div className="relative flex items-center bg-white border-4 border-black p-1">
              ...
              <Mail className="absolute left-4 text-black z-10" size={20} />
              ...
              <input 
                ...
                // FIXED: pl-12 prevents text from overlapping icon.
                // Removed 'uppercase' to allow normal typing.
                className="w-full pl-12 p-4 font-bold lowercase italic outline-none placeholder:uppercase text-black text-lg"
                required
              />
            </div>
          </div>
        ...
        <div className="relative flex items-center my-12">
          ...
          <span className="mx-4 font-[1000] italic text-xs uppercase text-black">OR FAST ACCESS</span>
          <div className="flex-grow border-t-4 border-black"></div>
        </div>
        ...
        <AnimatePresence>
          {message && (
            <motion.div 
              ...
              exit={{ opacity: 0 }}
              className="mt-8 font-black text-center text-black uppercase italic bg-yellow-400 p-4 border-4 border-black shadow-brutal-sm text-sm"
            >
              {message}
            </motion.div>
          )}
        ...
        <p className="mt-8 text-[9px] font-[1000] text-gray-400 uppercase italic text-center tracking-[0.2em]">
          No password. pure frictionless entrance.
        </p>
      </motion.div>
    </main>
  );
